...
const styles = {
  buttonStyle: {
    flex: 1, // I want this button to expand and fill 1/1 space - as much content as it can,
    // as we did with the picture in the AlbumDetail component
    alignSelf: 'stretch',
    /* flexbox property,
       like alignItems for sorting items within a container component/element horizontally.
       alignSelf is for the element to position it self using flexbox rules.
       stretch - stretch to fill the limits of the container.
    */
    backgroundColor: '#fff',
